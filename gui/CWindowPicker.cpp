...
int CWindowButton::ProcessMouse(int mx, int my, UINT mevent, CControl **mhook, CControl **khook)
{
	if (!show)
		return 1;
...
int CWindowPicker::ProcessMouse(int mx, int my, UINT mevent, CControl **mhook, CControl **khook)
{
