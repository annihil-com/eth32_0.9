...
static const windef_t windows[] = 
{
	...
	},
	{
		...
		10,						// num controls
		{
			...
			{ CTRL_CHECKBOX,	"Panzer Suicide",	5,		160,	140,	8,		(int)&eth32.settings.panzerSuicide },
			{ CTRL_FLOATSLIDER,	"Impact Distance",	5,		174,	140,	20,		SETFLOAT(40.0), SETFLOAT(500.0), (int)&eth32.settings.panzerImpactDist },	
		},
	},
	{
		"Winamp",				// title
